...
class stops_function extends  route_and_group_and_sort_function
{
    ...
    public function daily_stopsAVG($link, $datetime, $datetimeavg, $routekey, $groupkey)
    {
        ...
        if (!empty($route)) {
            ...
            log::logInsert('route null in daily_stopsAVG date #' . $datetime, log_file_stops_name_and_folder, WARNING);
            return null;
        }
    }
    ...
    public function daily_missed_stops_CALENDAR($link, $datetime, $routekey, $groupkey, $missed)
    {
        ...
        if (!empty($route)) {
            ...
            log::logInsert('route null in daily_missed_stops_CALENDAR date #' . $datetime, log_file_stops_name_and_folder, WARNING);
            return null;
        }
    }
    ...
    public function daily_array_stops_collection($link, $date, $offset, $count, $routekey, $groupkey, $columnsorting, $sort)
    {
        ...
        if (!empty($route)) {
            ...
            log::logInsert('route null in daily_array_stops_per_collection date #' . $date, log_file_stops_name_and_folder, WARNING);
            return null;
        }
    }
    ...
    public function daily_pos_count($link, $date, $routekey, $groupkey)
    {
        ...
        if (!empty($route)) {
            ...
            log::logInsert('route null in daily_pos_count date #' . $date, log_file_stops_name_and_folder, WARNING);
            return null;
        }
    }
}